...
public class TestController {
    ...
    public ResponseEntity<Map<String, Object>> identifyWorkoutPlanMethods() {
        ...
        try {
            ...
            java.lang.reflect.Method[] methods = com.chidituke.workout_tracker.model.WorkoutPlan.class.getDeclaredMethods();
            ...
            for (String methodName : methodsToCheck) {
                try {
                    com.chidituke.workout_tracker.model.WorkoutPlan.class.getMethod(methodName);
