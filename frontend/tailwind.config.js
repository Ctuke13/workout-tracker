...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      // Your existing font family (preserved)
      fontFamily: {
        'inter': ['Inter', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
      },
      // Your existing animations (preserved) + shadcn animations
      animation: {
      ...
      // Your existing box shadows (preserved)
      boxShadow: {
  ...
  corePlugins: {
    preflight: false, // Keeps your MUI compatibility
  }
}