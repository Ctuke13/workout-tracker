...
const ProblemSection: React.FC = () => {
    ...
    const ProblemCard: React.FC<ProblemCardProps> = ({ problem, index }) => (
        <div className="group bg-light-card border border-light-border rounded-xl p-6 hover:border-red-300 hover:shadow-light-card-hover hover:shadow-red-200/20 transition-all duration-300 hover:transform hover:scale-105">
            {/* Icon */}
    ...
    return (
        <section
            id="problem"
            className="py-4 md:py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-red-50 via-orange-50 to-light-bg-secondary animate-on-scroll"
        >
