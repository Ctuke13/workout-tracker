...
public class WorkoutSessionMapper {
    ...
    public WorkoutSessionResponse toResponse(WorkoutSession entity) {
        ...
        return WorkoutSessionResponse.builder()
                ...
                .workoutPlanId(entity.getWorkout() != null ? entity.getWorkout().getId() : null)
                .workoutPlanName(entity.getWorkout() != null ? entity.getWorkout().getWorkoutName() : null)
                .workoutPlanCategory(entity.getWorkout() != null ? entity.getWorkout().getWorkoutCategory() : null)
